...
const TIER_INFO = {
  black: {
    eco: {
      ...
      includes: [
        ...
        'სექციური ალუმინის რადიატორები',
        'ბეტონის საფარი (5–7 სმ)',
        'კედლის მოგვება-შელესვა (მექანიკური ან ხელით)',
    ...
    standard: {
      ...
      includes: [
        ...
        'გათბობის მილების გაყვანა და გამართვა',
        'სექციური ფოლადის რადიატორები',
        'ბეტონის საფარი (5–7 სმ)',
        'ორ-ფენიანი გლუვი ჭერი (გიფსოკარტონის ელემენტებით)',
        'კედლის შეღებვის საფუძველი + გლუვი ასრული ფენა',
    ...
    premium: {
      ...
      desc: 'ევროპული ბრენდული მასალები, ავტომატური სისტემები, ინდივიდუალური დიზაინის პროექტი ჩართულია.',
      includes: [
        'ელექტრო გაყვანილობა (NYM EU, ABB / Hager, ავტომატიზაცია)',
  ...
  white: {
    eco: {
      ...
      desc: 'კედლები მოსაპირკეთებელია, სანტექნიკა და ელექტრო გათვალისწინებულია. მხოლოდ სამოსახლო სამუშაოები.',
      includes: [
        'იატაკი — ლამინატი ან კერამიკა (ეკონომ კლასი)',
        'კედლები — კედლის შეღებვის საფუძველი + საღებავი (1–2 ფენა)',
        'ჭერი — გადასაკრავი ან საღებავი',
        'კარ-ფანჯრის მოპირკეთება',
        'სველი კვანძი — სტანდარტული კერამიკა',
        'შიდა კარები (საჭიროების შემთხვევაში)',
      ],
      excludes: [
    ...
    standard: {
      ...
      desc: 'ელექტრო/სანტექნიკის ნაწილობრივი განახლება საჭიროების შემთხვევაში, ხარისხიანი მასალები.',
      includes: [
        'ელექტრო — ნაწილობრივი განახლება (სარდომები, განათება)',
        'სანტექნიკა — სველი კვანძის სრული განახლება',
        'კედლის შეღებვის საფუძველი + ბოჭკოვანი ქაღალდი',
